...
class ventana_principal_usu :
    ...
    def form (self):
        ...
        label1 = tk.Label(frame_3, text=self.nombre_proceso,borderwidth=1, relief="solid", font=self.fuente_normal)
        label1.pack(side='top', padx=10, pady=10)
    
        label1 = tk.Label(frame_3, text=self.descripcion,borderwidth=1,width=70,height=3, relief="solid",  font=self.fuente_negrita)
